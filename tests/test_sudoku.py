...
def sudoku1():
    """
    Changed puzzle to be a list containing lists of integers (was a list with a a string) in sudoku.pyto optimize the code.
    However, this meant the test_sudoku.py puzzle variables also had to be changed to accomodate for this fact.
    """
    puzzle = [
        [7, 9, 0, 0, 0, 0, 3, 0, 1],
        [0, 0, 0, 0, 0, 6, 9, 0, 0],
